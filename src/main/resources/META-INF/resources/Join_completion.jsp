      ...
      <div class="container" style="margin-top: 50px; margin-bottom: 120px">
        ...
        >
          <div class="row">
            ...
            <div
              class="col fw-bold bg-dark bg-opacity-50 text-white p-1 ps-5 pe-5"
            >
              가입완료
            </div>
          </div>
        ...
        <div class="text-center">
          <div class="fs-2 fw-bold border-topr p-4">회원가입 완료</div>
          <div class="bg-secondary bg-opacity-10 p-4">
            <div>홀리피트니스의 회원가입을 환영합니다!</div>
            <div>로그인 후 모든 서비스를 이용하실 수 있습니다.</div>
          </div>
